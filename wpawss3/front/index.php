...
<link rel="stylesheet" href="<?php echo plugins_url('wpawss3') . '/assets/css/style.css'; ?>">
...
<script src="<?php echo plugins_url('wpawss3').'/assets/js/jquery-3.2.1.min.js'; ?>"></script>
<script src="<?php echo plugins_url('wpawss3').'/assets/js/app.js'; ?>"></script>
